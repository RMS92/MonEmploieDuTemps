...
public class EdtControler implements Initializable {
	...
	private void chargerMatiere(Label label, ArrayList<Seance> g, EdtEtudiantTable eT, int i) {
		// NOM MATIERE
	...
	public void chargerCasesEdt(ArrayList<Seance> g, EdtEtudiantTable eT) {
