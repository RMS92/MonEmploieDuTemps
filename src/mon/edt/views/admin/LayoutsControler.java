...
public class LayoutsControler implements Initializable {
	...
	@FXML
	private EdtModifsControler edtModifsController;
	@FXML
	...
	public void handleButtonAction(MouseEvent event) {
		...
		if(event.getSource() == infosEdtModifs) {
			chargerEdtModifs();
		}
	}
	...
	private void chargerEdt() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtAdmin.fxml"));
	...
	private void chargerEdtInverse() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtInverseAdmin.fxml"));
	...
	private void chargerEdtGrille() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtGrilleAdmin.fxml"));
	...
	private void chargerEdtModifs() {

		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtModifsAdmin.fxml"));
		...
		edtModifsController = loader.getController();
		rootPane.setCenter(centerPane);
	}
	...
	private void chargerInfos() {
		...
		// setterLabel
		nomLabel.setText(this.u.getNom());
	}
