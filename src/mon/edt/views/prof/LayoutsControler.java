...
public class LayoutsControler implements Initializable {
	...
	private void chargerEdt() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtEnseignant.fxml"));
	...
	private void chargerEdtInverse() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtInverseEnseignant.fxml"));
	...
	private void chargerEdtGrille() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("EdtGrilleEnseignant.fxml"));
	...
	private void chargerRecap() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("RecapEnseignant.fxml"));
	...
	private void chargerReporting() {
		...
		final FXMLLoader loader = new FXMLLoader(getClass().getResource("ReportingEnseignant.fxml"));
