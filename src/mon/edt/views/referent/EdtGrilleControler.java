...
public class EdtGrilleControler implements Initializable{
	...
	@FXML
    public void searchSemaine1() {
		initList();
		remplirTab(this.currentSemaine);
	}
    ...
    private ObservableList<EdtColonne> getDataColonneLundi(int semaine, String research) {
    	...
    	this.ids = eT.findAllProf(this.u.getId(), semaine, research);//SEMAINE
    	this.e = new ArrayList<Seance>();
    	for(int i = 0; i < this.ids.size(); i++) {
    		 		
    		Seance ne = eT.findSeance(this.ids.get(i));
    		this.e.add(ne);
    	}
    	
    	for(int i = 0; i < this.e.size(); i++) {	
    		System.out.println(this.e.get(i).getId());
...
private ObservableList<EdtColonne> getDataColonneMardi(int semaine, String research) {
...
private ObservableList<EdtColonne> getDataColonneMercredi(int semaine, String research) {
...
private ObservableList<EdtColonne> getDataColonneJeudi(int semaine, String research) {
...
private ObservableList<EdtColonne> getDataColonneVendredi(int semaine, String research) {
...
private ObservableList<EdtColonne> getDataColonneSamedi(int semaine, String research) {
